...
impl NotifyChangeEventsError {
    pub fn invalid_path(path: &str, notify_error: NotifyError) -> NotifyChangeEventsError {
        NotifyChangeEventsError::InvalidPath(InvalidPathError { path: String::from(path), notify_error })
    }
