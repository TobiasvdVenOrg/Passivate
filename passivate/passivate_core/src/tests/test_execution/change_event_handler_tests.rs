...
use crate::test_helpers::fakes::stub_with_test_run_processor_and_tests_sender;
...
pub fn when_test_run_fails_error_is_reported() {  
    ...
    let mut handler = stub_with_test_run_processor_and_tests_sender(processor, tests_sender);
